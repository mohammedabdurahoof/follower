...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
        <img class="animation__shake" src="{{ config('app.asset_url') }}/vendor/adminlte/dist/img/FollowerLogo.png" alt="AdminLTELogo" height="60" width="60">
    </div>
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <a class="dropdown-item text-center" href="{{ route('client.logout') }}" 
    ...
    <aside class="main-sidebar sidebar-dark-warning elevation-4">
        ...
        <a href='#' class="brand-link">
          <img src="{{ config('app.asset_url') }}/vendor/adminlte/dist/img/FollowerLogo.png" alt="Follower Logo" class="brand-image elevation-3" style="max-height: 40px; border-radius: 15%; opacity: 1">
          <span class="brand-text font-weight-light">OLLOWER's</span>
        </a>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                ...
                <!-- Add icons to the links using the .nav-icon class
                    ...
                    <li class="nav-item menu-open">
                      <a href="{{ route('award.list') }}" class="nav-link active">
                    ...
                    <li class="nav-item menu-open">
                      <a href="{{ route('client.fullimage.list') }}" class="nav-link active">
                    ...
                    <li class="nav-item menu-open">
                        <a href="{{ route('client.data.upload.list') }}" class="nav-link active">
...
<!--                    <li class="nav-item menu-open">
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <dt>Place:</dt>
                                                    <dd>{{ Auth::user()->place }}</dd>
                                                </div>
                                                <div class="col-md-4">
                                                    <dt>Cadre:</dt>
                                                    <dd>{{ Auth::user()->cadre }}</dd>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="col-md-12">
                                                <dd ><img style='border-radius: 10px;' id="image-{{ Auth::id() }}" src="{{ config('app.uploaded_assets').Auth::user()->logo }}" width="110px"></dd>
                                            </div>
                                        </div>
                                    </div>
                                </dl>
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2021-{{ date('Y') }} <a href="#">SunGlobal</a>.</strong>
        All rights reserved.
...
<!--<script src="{{ config('app.asset_url') }}/vendor/adminlte/plugins/jquery-ui/jquery-ui.min.js"></script>-->
<!-- Bootstrap -->
